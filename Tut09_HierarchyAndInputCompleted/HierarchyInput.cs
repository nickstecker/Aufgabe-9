...
namespace Fusee.Tutorial.Core
{
    public class HierarchyInput : RenderCanvas
    {
        ...
        private TransformComponent _GreifHandObenTransform;
        private TransformComponent _GreifHandUntenTransform;
        ...
        SceneContainer CreateScene()
        {
            ...
            _GreifHandObenTransform = new TransformComponent
            {
                Rotation = new float3(0, 0, 0),
                Scale = new float3(0.3f, 0.4f, 0.6f),
                Translation = new float3(0.1f, 9, 0)
            };
             _GreifHandUntenTransform = new TransformComponent
            {
                Rotation = new float3(0, 0, 0),
                Scale = new float3(0.3f, 0.4f, 0.6f),
        ...
        public override void RenderAFrame()
        {
            ...
            _GreifHandObenTransform.Rotation = new float3(0, 0, _GreifHandObenTransform.Rotation.z + Keyboard.ADAxis * Time.DeltaTime);
            _GreifHandUntenTransform.Rotation = new float3(0, 0, _GreifHandUntenTransform.Rotation.z - Keyboard.ADAxis * Time.DeltaTime);
